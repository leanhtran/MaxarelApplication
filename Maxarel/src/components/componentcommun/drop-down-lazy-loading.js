...
const DEBOUND_TIME_DETECT_TO_TOP = 50;

export default class DropdownLazyLoading extends Component {
	static propTypes = {
...

				{
					...
					(
						<View style={styles.button}>
							...
							<Image style = {styles.imageArrowDropDown}
	...
	isScrollToTop = ({ layoutMeasurement, contentOffset, contentSize }) => {
	...
	}, DEBOUND_TIME_DETECT_TO_TOP).bind(this);
	_renderDropdown() {
		const { scrollEnabled, renderSeparator, showsVerticalScrollIndicator, keyboardShouldPersistTaps, renderFooter } = this.props;
		return (
